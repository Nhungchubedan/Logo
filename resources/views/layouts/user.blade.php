...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- <script src="//code.tidio.co/rllvphflwc0vuczyqwhafqupb1zet0iy.js" async></script> -->
    </head>
    <body>
        <div id="root" class="h-100 bg-light">
            @include('components.header')
            <div style="margin-top: 70px;" >
                <div class="bg-white w-100 m-auto">
                    <div style="width:80%;" class="m-auto">
                        <p class="fs-xs pt-4 pb-8">
                            <a href="{{route('welcome')}}" class="text-gray-600 ">TRANG CHỦ</a>
                            <i class="fa-solid fa-chevron-right text-gray-600"></i>
                            <span class="text-black">@yield('link')</span>
                        </p>
